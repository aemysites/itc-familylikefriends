...
## Environments
- Preview: https://main--itc-familylikefriends--aemysites.aem.page/
- Live: https://main--itc-familylikefriends--aemysites.aem.live/
- Block Library: https://main--itc-familylikefriends--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `itc-familylikefriends` directory in your favorite IDE and start coding :)
